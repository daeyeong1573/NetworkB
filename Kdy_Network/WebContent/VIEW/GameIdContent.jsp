...
IdDTO dto = dao.idContent(gameid,"game");
%>
...
<form name="frm" action="IdUpdate.jsp" method="post">
	<table border=1 style="background-color: white;">
		<tr>
			<td>아이디</td>
			<td><input type="text" id="gameid" name="gameid" readonly="readonly"
				value="<%=dto.getGameid()%>"></td>
		</tr>
		<tr>
			<td>비밀번호</td>
		...
		<td colspan="3" style="text-align: center;"><input type="button"
			...
			value="조회" onClick="location.href='gameIdList.jsp'">
		</tr>
	</table>
