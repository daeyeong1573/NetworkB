...
IdDTO dto = dao.idContent(webid,"web");
%>
...
<form name="frm" action="IdUpdate.jsp" method="post">
	<table border=1 style="background-color: white;">
		<tr>
			<td>아이디</td>
			<td><input type="text" id="webid" name="webid" readonly="readonly"
				value="<%=dto.getWebid()%>"></td>
		</tr>
		<tr>
			<td>비밀번호</td>
		...
		<td colspan="3" style="text-align: center;"><input type="button"
			...
			value="조회" onClick="location.href='WebIdList.jsp'">
		</tr>
	</table>
